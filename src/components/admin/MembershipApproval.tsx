...
const MembershipApproval: React.FC = () => {
    ...
    try {
      ...
      const { error: notificationError } = await supabase
        ...
        .insert({
          ...
          message: 'Your membership application has been rejected. Please contact support for more information or resubmit with correct payment details.'
        });
  ...
  if (loading) {
    return <div className="flex justify-center p-8">Loading pending memberships...</div>;
  }
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-2xl font-bold text-iteam-primary">Pending Membership Approvals</h2>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <Avatar className="h-12 w-12">
                  ...
                  <AvatarFallback>
                    {membership.profiles.first_name[0]}{membership.profiles.last_name[0]}
                  </AvatarFallback>
                </Avatar>
              ...
              <div className="flex items-center space-x-2">
                    ...
                    <DialogContent className="max-w-2xl">
                      ...
                      <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div>
                            <strong>Payment Date:</strong> {membership.payments[0].payment_date}
                          </div>
                          <div>
                            <strong>Amount:</strong> Rs. {membership.payments[0].amount}
                          </div>
                        </div>
                ...
                <Button
                  onClick={() => approveMembership(membership.id, membership.user_id)}
                ...
                <Button
                  onClick={() => rejectMembership(membership.id, membership.user_id)}
                  variant="destructive"
                  size="sm"
                >
